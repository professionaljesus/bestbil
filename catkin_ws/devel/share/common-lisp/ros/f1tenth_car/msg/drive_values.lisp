...
(cl:defmethod cl:initialize-instance :after ((m <drive_values>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'drive_values)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_car-msg:<drive_values> is deprecated: use f1tenth_car-msg:drive_values instead.")))

(cl:ensure-generic-function 'pwm_drive-val :lambda-list '(m))
(cl:defmethod pwm_drive-val ((m <drive_values>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_car-msg:pwm_drive-val is deprecated.  Use f1tenth_car-msg:pwm_drive instead.")
  (pwm_drive m))

(cl:ensure-generic-function 'pwm_angle-val :lambda-list '(m))
(cl:defmethod pwm_angle-val ((m <drive_values>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_car-msg:pwm_angle-val is deprecated.  Use f1tenth_car-msg:pwm_angle instead.")
  (pwm_angle m))
