...
(cl:defmethod cl:initialize-instance :after ((m <drive_param>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'drive_param)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_car-msg:<drive_param> is deprecated: use f1tenth_car-msg:drive_param instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <drive_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_car-msg:velocity-val is deprecated.  Use f1tenth_car-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <drive_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_car-msg:angle-val is deprecated.  Use f1tenth_car-msg:angle instead.")
  (angle m))
