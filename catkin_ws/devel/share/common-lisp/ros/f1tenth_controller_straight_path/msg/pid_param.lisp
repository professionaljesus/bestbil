...
(cl:in-package f1tenth_controller_straight_path-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <pid_param>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pid_param)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_controller_straight_path-msg:<pid_param> is deprecated: use f1tenth_controller_straight_path-msg:pid_param instead.")))

(cl:ensure-generic-function 'kp-val :lambda-list '(m))
(cl:defmethod kp-val ((m <pid_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_controller_straight_path-msg:kp-val is deprecated.  Use f1tenth_controller_straight_path-msg:kp instead.")
  (kp m))

(cl:ensure-generic-function 'ki-val :lambda-list '(m))
(cl:defmethod ki-val ((m <pid_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_controller_straight_path-msg:ki-val is deprecated.  Use f1tenth_controller_straight_path-msg:ki instead.")
  (ki m))

(cl:ensure-generic-function 'kd-val :lambda-list '(m))
(cl:defmethod kd-val ((m <pid_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_controller_straight_path-msg:kd-val is deprecated.  Use f1tenth_controller_straight_path-msg:kd instead.")
  (kd m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <pid_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_controller_straight_path-msg:velocity-val is deprecated.  Use f1tenth_controller_straight_path-msg:velocity instead.")
  (velocity m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<pid_param>)))
  ...
  "f1tenth_controller_straight_path/pid_param")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'pid_param)))
  "Returns string type for a message object of type 'pid_param"
  "f1tenth_controller_straight_path/pid_param")
