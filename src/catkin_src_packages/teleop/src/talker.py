...
def talker():
	...
	sub = rospy.Subscriber('f1tenth_controller_straight_path/output', drive_param, updatePWM)
...
#0=9831
	...
	if vel == 100:
		values.pwm_drive = 13108
	elif vel == -100:
		values.pwm_drive = 6554
	else:
		values.pwm_drive = 9831

	if ang == 100:
		values.pwm_angle = 13108
	elif ang == -100:
		values.pwm_angle = 6554
	else:
